  ...
  return (
    <div >
      <div className="xl:h-[600px] md:h-[400px] lg:h-[500px] h-[350px] w-full bg-no-repeat bg-cover bg-center relative overflow-hidden">
        ...
        <Image
          className=" bg-white opacity-100 inset-0 object-cover filter brightness-50  pointer-ev"
          ref={imageRef}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            Don't just host events, create memories. Expert planning for impactful experiences that leave a lasting impression
            </p>
          </div>
    ...
    <div className="mt-44">
      ...
      <div className="sm:mt-52 mt-20">
        ...
        <div className="bg-[#F9EBE9] w-full rounded-md ">
            ...
            EventNow provides a user-friendly interface that guides you through the entire event creation process, from start to finish. 
            Manage everything from creating events and selling tickets to  engaging with attendees all within a single, convenient hub. 
            </div>
          </div>
          ...
          <div className="bg-[#F9EBE9] w-full rounded-md ">
            ...
            <div className="px-8 pb-4 text-lg text-center">
            Explore a vast variety of events happening near you, from concerts and conferences to festivals and workshops. 
            Booking your spot is a breeze with our secure platform that allows you to register in just a few clicks. 
          ...
          <div className="bg-[#F9EBE9] w-full rounded-md font-['Khand']">
            ...
            <div className="px-8 pb-4 text-lg text-center">
            No matter the size or scale of your event, from intimate gatherings to large conferences or virtual events, 
            EventNow caters to your specific needs. Design a ticketing system that drives sales with a variety of options,
             including different ticket tiers with varying prices and perks. 
            </div>
          </div>
          ...
          <div className="bg-[#F9EBE9] w-full rounded-md font-['Khand']">
            ...
            <div className="px-8 pb-4 text-lg text-center">
            Enjoy complete peace of mind with a secure platform that safeguards both organizers and attendees. 
            Our robust security measures protect financial information during ticket purchases, and advanced fraud prevention
             systems ensure all transactions are conducted safely and transparently.
            </div>
          </div>
        ...
        <div className="grid sm:grid-cols-3 sm:gap-4">
          ...
          <div className="mt-8">
            <div className="grid grid-rows-2">
              ...
              <div className="xl:pt-8 text-center xl:px-20 text-md lg:text-lg   font-semibold">
                Effortlessly create and customize your events with our intuitive platfor
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <div className="grid grid-rows-2 -mt-20 sm:mt-0">
              ...
              <div className="xl:pt-8 text-center xl:px-20 text-md lg:text-lg  font-semibold">
               Discover a wide range of exciting, diverse events tailored to your interests.
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <div className="grid grid-rows-2 -mt-20 sm:mt-0">
              ...
              <div className="xl:pt-8 text-center xl:px-20 text-md lg:text-lg   font-semibold">
               Easily check in and enjoy a seamless event experience with real-time updates.
              </div>
            </div>
          </div>
