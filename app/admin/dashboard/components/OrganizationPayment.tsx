...
export default function OrganizationPayment({
  ...
  return (
    <div>
      <div
        className={`grid grid-cols-1 lg:grid-cols-11 md:grid-cols-1  sm:m-6  ${value} h-auto md:h-auto lg:h-32 rounded-lg bg-[#ffffff] mt-6 ms-4 lg:ms-4 md:ms-20 border-2`}
      >
        ...
        <div className="col-span-full md:col-span-2 lg:col-span-4 flex justify-center sm:justify-start pl-8 sm:mt-0 md:mt-4 lg:mt-0">
