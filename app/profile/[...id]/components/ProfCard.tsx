...
function ProfCard({ profilePic, name, email }: ProfileCard) {
  return (
    <div className=" flex flex-col text-gray-700  bg-clip-border rounded-xl w-fit my-5  ">
      <div className=" mx-4 mt-4 overflow-hidden text-gray-700 shadow-lg bg-clip-border rounded-full h-fit">
        <Image
          src={`${profilePic}`}
          width={200}
          height={200}
