...
export default function ShowTicketsForUserModal({
  setIsActiveTicketModal,setIsActiveProceedTicketModal,ticketArrayTemp,setTicketArrayTemp ,ticketTypes,totalPrice,setTotalPrice
}: {
  ...
  const handleVisible = () => {
    ...
    console.log(ticketArrayTemp, "allBuyTicketsArrayTemp")
  };
    ...
    >
      <div className="border-[1px] border-custom-orange rounded-md bg-white  w-3/5 relative top-[20%] left-[20%]">
        <div className="flex justify-between bg-slate-300">
          <button className="text-slate-400 ml-3" onClick={handleBackArrowClick}>
